            ...
            <div>
                ...
                <div className='row' style={{height:'40%'}}>
                    ...
                    <div className='col-md-5 col-md-offset-1 col-xs-10 col-xs-offset-2 menuImgLeft'>
                        <div href={'/choosemymeal'}  className='homepageButton homepageButton1' style={{textAlign:'center'}}>
                            <br></br>
                    ...
                    <div className='col-md-3 col-md-offset-1 col-xs-10 col-xs-offset-2 menuImgRight'>
                        <div className='homepageButton homepageButton2' >
                             <br></br>
                ...
                <div className='row' style={{height:'40%'}}>
                    <div className='col-md-5 col-md-offset-1 col-xs-10 col-xs-offset-2 menuImgLeft'>
                        <div className='homepageButton homepageButton3' >
                             <br></br>
                    ...
                    <div className='col-md-3 col-md-offset-1 col-xs-10 col-xs-offset-2 menuImgRight'>
                         <div className='homepageButton homepageButton4' >
                              <br></br>
